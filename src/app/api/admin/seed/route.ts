...
export async function GET() {
  try {
    ...
    await db.insert(authorProfile).values({
      name: 'Rey Ecstasia',
      bio: `<p>Hey! I'm <strong>Rey Ecstasia</strong>.</p><p>I'm a writer who explores the raw, unfiltered dimensions of human experience — from desire and heartbreak to self-discovery and societal truths. My work spans erotica, romance, storytelling, and reflective essays that challenge how we think about love, identity, and the world around us.</p><p>I started this blog in December 2019, and it's been an incredible journey of creative expression ever since. Whether I'm writing a steamy short story or dissecting the themes of a Netflix film, I pour my whole self into every word.</p><p>I believe in the power of storytelling to heal, provoke, and connect. So stick around, read something that moves you, and let's create beautiful written memories together.</p><p><em>It's your girl, Rey Ecstasia…</em></p>`,
      achievements: `<ul><li>Creator of "Your Rey Of Ecstasy" — an independent creative writing platform</li><li>Published stories spanning multiple genres: Erotica, Romance, Storytelling, Self-Discovery</li><li>Building a dedicated readership since December 2019</li><li>Featured storyteller across Love & Emotional Healing, Society & Culture Reflections</li></ul>`,
      facebookUrl: 'https://web.facebook.com/IamIyolga/',
      instagramUrl: 'https://instagram.com/reyecstasia',
    ...
    await db.insert(blogPosts).values([
      {
        ...
        excerpt: "heya! I'm Rey Ecstasia. I'm super excited to start my journey on here with you all.",
        content: `<p>heya! I'm Rey Ecstasia.</p><p>I'm super excited to start my journey on here with you all. It is with utmost pleasure that I ask you to stick around and create beautiful written memories with me!</p><p>I'm just getting this new blog going, so stay tuned for more. Subscribe below to get notified when I post new updates!</p>`,
